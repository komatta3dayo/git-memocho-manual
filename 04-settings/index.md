# Gitリポジトリ設定
Git関連の設定を行います。  
<img src="./img/04-settings-detail-001.png" width="30%">  

## Gitリポジトリ接続設定リスト
- 一番左端のボタンをタップすると`Gitリポジトリ接続設定を編集`ダイアログが表示され、新規の設定を追加できます。
<img src="./img/04-settings-git-001.png" width="30%">  <img src="./img/04-settings-git-002.png" width="30%">  
  - Git接続設定の名前  
...
# 表示設定
画面表示に関する設定を行います。  
<img src="./img/04-settings-detail-002.png" width="30%">  
...
# 履歴設定・操作設定・その他
<img src="./img/04-settings-detail-003.png" width="30%"> <img src="./img/04-settings-detail-004.png" width="30%">
